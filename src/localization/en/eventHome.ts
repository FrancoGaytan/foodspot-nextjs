export default Object.seal({
  ...
  closed: 'closed',
  eventLifecycleLabel: 'Event progress',
  eventOpenStep: 'Open',
  eventClosedStep: 'Closed',
  eventPaymentStep: 'Ready for payment',
  eventFinishedStep: 'Finished',
  canceled: 'canceled',
  full: 'full',
  finished: 'finished',
  debtor: 'debtor',
