    ...
    <div className={styles.paycheck}>
      <div className={styles.paycheckContent}>
        ...
        <section className={styles.btnSection}>
          <Button className={styles.confirmPayBtn} kind={ButtonKind.WHITE_PRIMARY} size="short" onClick={() => confirmPayment(props.transferReceiptId)}>
            {t.confirmPayBtn}
          </Button>
					<Button className={styles.rejectPayBtn} kind={ButtonKind.WHITE_SECONDARY} size="short" onClick={() => rejectPayment(props.transferReceiptId)}>
						{t.rejectPayBtn}
					</Button>
        </section>
